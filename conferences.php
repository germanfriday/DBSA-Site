<?php $section  = "Support"; $subsection = "Conferences"; ?>
...
<title>Support :: Conferences :: DBSA Metro Detroit</title>
<style type="text/css">
<!--
body {
  ...
  <table width="750" height="585" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="605" height="395" valign="top" background="images/page_filler.gif"><table width="605" height="395" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="605" height="45" valign="top"><div align="left"><img src="images/conferences_title.jpg" width="605" height="45" /></div></td>
        </tr>
        <tr>
