...
if ( of_get_option('copyright','1') == '1' ) { ?>
    <div id="copyright" class="container">
    	<?php if ( of_get_option('custom_copyright','') !== '' ) {
			echo do_shortcode( of_get_option('custom_copyright','') ); 
		} else { ?>
        <p>
        	<a href="http://wordpress.org" title="WordPress">WordPress</a> Theme
    		<?php _e('Theme by','wpex'); ?> <a href="http://wpexplorer.me" title="WPExplorer">WPExplorer</a>
        </p>
    <?php } ?>
    </div><!-- #copyright -->
<?php } ?>
...
<div id="backtop-wrap" class="container clr">
	<a href="#backtop" title="<?php _e('Scroll To Top','wpex'); ?>" class="backtop"><span class="icon-arrow-up"></span></a>
</div><!-- #backtop-wrap -->
